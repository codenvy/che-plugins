 ...
 * </pre>
 * <p>
 * Note: This type of node is a convenience of sorts. An equivalent way to represent the same statement is to use a
 * <code>VariableDeclarationExpression</code> wrapped in an <code>ExpressionStatement</code>.
 * </p>
 *
...
public class VariableDeclarationStatement extends Statement {
    ...
    public static final SimplePropertyDescriptor MODIFIERS_PROPERTY = new SimplePropertyDescriptor(
            VariableDeclarationStatement.class, "modifiers", int.class, MANDATORY); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor TYPE_PROPERTY = new ChildPropertyDescriptor(
            VariableDeclarationStatement.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    /**
     * The list of variable variable declaration fragments (element type: {@link VariableDeclarationFragment}). Defaults to an
     * empty list.
     */
    private ASTNode.NodeList<VariableDeclarationFragment> variableDeclarationFragments =
            new ASTNode.NodeList<VariableDeclarationFragment>(FRAGMENTS_PROPERTY);

    /**
     * Creates a new unparented local variable declaration statement node owned by the given AST. By default, the variable
     ...
     *
     * @param modifiers
     *         the given modifiers (bit-wise or of <code>Modifier</code> constants)
     * @throws UnsupportedOperationException
   ...
   /* package */
    ...
    /**
     * Returns the live list of variable declaration fragments in this statement. Adding and removing nodes from this list affects
