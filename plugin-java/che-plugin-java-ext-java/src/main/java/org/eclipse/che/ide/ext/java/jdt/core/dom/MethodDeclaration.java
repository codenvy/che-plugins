...
public class MethodDeclaration extends BodyDeclaration {
    ...
    public static final SimplePropertyDescriptor CONSTRUCTOR_PROPERTY = new SimplePropertyDescriptor(
            MethodDeclaration.class, "constructor", boolean.class, MANDATORY); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(MethodDeclaration.class,
                                                                                            "name", SimpleName.class, MANDATORY,
    ...
    public static final ChildPropertyDescriptor RETURN_TYPE_PROPERTY = new ChildPropertyDescriptor(
            MethodDeclaration.class, "returnType", Type.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor RETURN_TYPE2_PROPERTY = new ChildPropertyDescriptor(
            MethodDeclaration.class, "returnType2", Type.class, OPTIONAL, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final SimplePropertyDescriptor EXTRA_DIMENSIONS_PROPERTY = new SimplePropertyDescriptor(
            MethodDeclaration.class, "extraDimensions", int.class, MANDATORY); //$NON-NLS-1$
    ...
    public static final ChildListPropertyDescriptor THROWN_EXCEPTIONS_PROPERTY = new ChildListPropertyDescriptor(
            MethodDeclaration.class, "thrownExceptions", Name.class, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor BODY_PROPERTY = new ChildPropertyDescriptor(MethodDeclaration.class,
                                                                                            "body", Block.class, OPTIONAL, CYCLE_RISK);
    //$NON-NLS-1$
     ...
     *
     * @param isConstructor
     *         <code>true</code> for a constructor declaration, and <code>false</code> for a method declaration
     */
   ...
   /* package */void internalSetReturnType(Type type) {
     ...
     *
     * @param type
     *         the new return type, possibly the void primitive type, or <code>null</code> if none
     * @throws UnsupportedOperationException
     *         if this operation is used in a JLS2 AST
     * @throws IllegalArgumentException
     *         if:
     ...
     * @throws IllegalArgumentException
     *         if the number of dimensions is negative
     * @since 2.1
     */
     ...
     *
     * @param body
     *         the block node, or <code>null</code> if there is none
     * @throws IllegalArgumentException
     *         if:
     *         <ul>
     *         <li>the node belongs to a different AST</li>
    ...
    int treeSize() {
        return memSize() + (this.optionalDocComment == null ? 0 : getJavadoc().treeSize())
               ...
               + this.thrownExceptions.listSize() + (this.optionalBody == null ? 0 : getBody().treeSize());
    }
}
