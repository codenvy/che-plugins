 ...
 * </pre>
 * <p>
 * Not all node arrangements will represent legal Java constructs. In particular, it is nonsense if the type is a primitive type
 * or an array type (primitive types cannot be instantiated, and array creations must be represented with
 * <code>ArrayCreation</code> nodes). The normal use is when the type is a simple, qualified, or parameterized type.
 * </p>
 * <p>
 ...
 * </ol>
 * The first form is preferred when "A" is known to be a type (as opposed to a package). However, a parser cannot always determine
 * this. Clients should be prepared to handle either rather than make assumptions. (Note also that the first form became possible
...
public class ClassInstanceCreation extends Expression {
    ...
    public static final ChildListPropertyDescriptor TYPE_ARGUMENTS_PROPERTY = new ChildListPropertyDescriptor(
            ClassInstanceCreation.class, "typeArguments", Type.class, NO_CYCLE_RISK); //$NON-NLS-1$
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(ClassInstanceCreation.class,
                                                                                            "name", Name.class, MANDATORY, NO_CYCLE_RISK);
    //$NON-NLS-1$
     ...
     * @since 3.1
     */
    public static final ChildPropertyDescriptor TYPE_PROPERTY = new ChildPropertyDescriptor(ClassInstanceCreation.class,
                                                                                            "type", Type.class, MANDATORY, NO_CYCLE_RISK);
    //$NON-NLS-1$
    ...
    public static final ChildListPropertyDescriptor ARGUMENTS_PROPERTY = new ChildListPropertyDescriptor(
            ClassInstanceCreation.class, "arguments", Expression.class, CYCLE_RISK); //$NON-NLS-1$
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor ANONYMOUS_CLASS_DECLARATION_PROPERTY = new ChildPropertyDescriptor(
            ClassInstanceCreation.class, "anonymousClassDeclaration", AnonymousClassDeclaration.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
    ...
    /** The type name; lazily initialized; defaults to a unspecified, legal type name. Not used in JLS3. */
    ...
    /**
     * Creates a new AST node for a class instance creation expression owned by the given AST. By default, there is no qualifying
     * expression, an empty list of type parameters, an unspecified type, an empty list of arguments, and does not declare an
     * anonymous class.
     * <p>
    ...
    ASTNode clone0(AST target) {
        ...
        result.setAnonymousClassDeclaration((AnonymousClassDeclaration)ASTNode.copySubtree(target,
    ...
    /**
     * Returns the expression of this class instance creation expression, or <code>null</code> if there is none.
     *
     ...
     *
     * @param expression
     *         the expression node, or <code>null</code> if there is none
   ...
   /* package */void internalSetName(Name name) {
     ...
     *
     * @return the live list of argument expressions (possibly empty) (element type: {@link Expression})
     */
     ...
     *
     * @param decl
     *         the anonymous class declaration, or <code>null</code> if none
     */
    ...
    /**
     * Resolves and returns the binding for the constructor invoked by this expression. For anonymous classes, the binding is that
    ...
    /**
     * Returns <code>true</code> if the resolved class type has been inferred from the assignment context (JLS4 15.12.2.8),
     * <code>false</code> otherwise.
     * <p/>
     * This information is available only when bindings are requested when the AST is being built.
     *
     * @return <code>true</code> if the resolved class type has been inferred from the assignment context (JLS3 15.12.2.8),
     *         <code>false</code> otherwise
     * @since 3.7.1
     */
