...
import org.eclipse.che.ide.ext.java.jdt.internal.core.util.KeyKind;
import org.eclipse.che.ide.ext.java.jdt.internal.core.util.KeyToSignature;
...
public final class BindingKey {
     ...
     * createWildcardTypeBindingKey("Ljava/util/ArrayList;", Signature.C_SUPER, "Ljava/lang/String;", 0) -&gt;
     ...
     *         one of {@link Signature#C_STAR}, {@link Signature#C_SUPER}, or {@link Signature#C_EXTENDS}
     * @param boundTypeKey
     *         the binding key of the bounding type.
     * @param rank
