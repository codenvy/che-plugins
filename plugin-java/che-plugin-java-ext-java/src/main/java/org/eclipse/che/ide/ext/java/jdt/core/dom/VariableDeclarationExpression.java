...
public class VariableDeclarationExpression extends Expression {
    ...
    public static final SimplePropertyDescriptor MODIFIERS_PROPERTY = new SimplePropertyDescriptor(
            VariableDeclarationExpression.class, "modifiers", int.class, MANDATORY); //$NON-NLS-1$
     ...
     * @since 3.0
     */
    private ASTNode.NodeList<ASTNode> modifiers = null;
    ...
    VariableDeclarationExpression(AST ast) {
        ...
        if (ast.apiLevel >= AST.JLS3) {
            this.modifiers = new ASTNode.NodeList<ASTNode>(MODIFIERS2_PROPERTY);
        }
    }
