...
public interface IJavaSearchConstants {
   ...
   /* Nature of searched element */
    ...
    /**
     * The searched element is an interface or annotation type. More selective than using {@link #TYPE}.
     *
     * @category searchFor
     * @since 3.3
     */
   ...
   /* Nature of match */
    ...
    /**
     * The search result is a declaration. Can be used in conjunction with any of the nature of searched elements so as to better
    ...
    /**
     * The search result is a type that implements an interface or extends a class. Used in conjunction with either TYPE or CLASS
     * or INTERFACE, it will respectively search for any type implementing/extending a type, or rather exclusively search for
     * classes implementing/extending the type, or interfaces extending the type.
     *
     * @category limitTo
     */
    int IMPLEMENTORS = 1;
    ...
    /**
     * The search result is a reference. Can be used in conjunction with any of the nature of searched elements so as to better
     * narrow down the search. References can contain implementers since they are more generic kind of matches.
     *
     * @category limitTo
     */
    int REFERENCES = 2;
    ...
    /**
     * The search result is a declaration, a reference, or an implementer of an interface. Can be used in conjunction with any of
    ...
    /**
     * When searching for field matches, it will exclusively find read accesses, as opposed to write accesses. Note that some
     * expressions are considered both as field read/write accesses: for example, x++; x+= 1;
     *
     * @category limitTo
     * @since 2.0
     */
    ...
    /**
     * When searching for field matches, it will exclusively find write accesses, as opposed to read accesses. Note that some
     * expressions are considered both as field read/write accesses: for example, x++; x+= 1;
     *
     * @category limitTo
     * @since 2.0
     ...
     * </pre>
     * <p/>
     * Searching references to the type <code>Test</code> using this flag in the above snippet will match only the reference in
     * italic.
     * </p>
     * <p>
    ...
    /**
     * Return only super field accesses or super method invocations (e.g. using the <code>super</code> qualifier).
     * <p>
     * When this flag is set, the kind of returned matches will depend on the specified nature of the searched element:
     * <ul>
     * <li>for the {@link #FIELD} nature, only {@link FieldReferenceMatch} matches will be returned,</li>
     * <li>for the {@link #METHOD} nature, only {@link MethodReferenceMatch} matches will be returned.</li>
     * </ul>
     * </p>
     *
     * @category limitTo
    ...
    /**
     * Return only primary field accesses or primary method invocations (e.g. using the <code>this</code> qualifier).
     * <p>
     * When this flag is set, the kind of returned matches will depend on the specified nature of the searched element:
     * <ul>
     * <li>for the {@link #FIELD} nature, only {@link FieldReferenceMatch} matches will be returned,</li>
   ...
   /* Syntactic match modes */
    ...
    /**
     * The search pattern contains one or more wild cards ('*') where a wild-card can replace 0 or more characters in the search
     * result.
     *
     * @category matchRule
