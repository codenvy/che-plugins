 ...
 * </p>
 *
 * @see org.eclipse.che.ide.ext.java.jdt.core.dom.ASTNode#subtreeMatch(ASTMatcher, Object)
 * @since 2.0
 */
public class ASTMatcher {
     ...
     *
     * @param matchDocTags
     *         <code>true</code> if doc comment tags are to be compared by default, and <code>false</code> otherwise
     ...
     *
     * @param list1
     *         the first list of AST nodes (element type: {@link ASTNode})
     * @param list2
     *         the second list of AST nodes (element type: {@link ASTNode})
     ...
     *
     * @param node1
     *         the first AST node, or <code>null</code>; must be an instance of <code>ASTNode</code>
     * @param node2
     *         the second AST node, or <code>null</code>; must be an instance of <code>ASTNode</code>
    ...
    public boolean match(AnnotationTypeDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc())
                && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) &&
                safeSubtreeListMatch(
                        node.bodyDeclarations(), o.bodyDeclarations()));
    }
    ...
    public boolean match(AnnotationTypeMemberDeclaration node, Object other) {
        ...
        // node type added in JLS3 - ignore old JLS2-style modifiers
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc())
                && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getType(), o.getType())
    ...
    public boolean match(ArrayCreation node, Object other) {
        ...
        return (safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.dimensions(), o.dimensions()) &&
                safeSubtreeMatch(
                        node.getInitializer(), o.getInitializer()));
    }
    ...
    public boolean match(AssertStatement node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeMatch(node.getMessage(),
                                                                                              o.getMessage()));
    }
    ...
    public boolean match(Assignment node, Object other) {
        ...
        return (node.getOperator().equals(o.getOperator())
                && safeSubtreeMatch(node.getLeftHandSide(), o.getLeftHandSide()) && safeSubtreeMatch(node.getRightHandSide(),
                                                                                                     o.getRightHandSide()));
    }
    ...
    public boolean match(CompilationUnit node, Object other) {
        ...
        return (safeSubtreeMatch(node.getPackage(), o.getPackage()) && safeSubtreeListMatch(node.imports(), o.imports()) &&
                safeSubtreeListMatch(
                        node.types(), o.types()));
    }
    ...
    public boolean match(ConditionalExpression node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression())
                && safeSubtreeMatch(node.getThenExpression(), o.getThenExpression()) && safeSubtreeMatch(
                node.getElseExpression(), o.getElseExpression()));
    }
    ...
    public boolean match(EnumConstantDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc())
                ...
                node.getAnonymousClassDeclaration(), o.getAnonymousClassDeclaration()));
    }
    ...
    public boolean match(IfStatement node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression())
                && safeSubtreeMatch(node.getThenStatement(), o.getThenStatement()) && safeSubtreeMatch(
                node.getElseStatement(), o.getElseStatement()));
    }
    ...
    public boolean match(InfixExpression node, Object other) {
        ...
        return (node.getOperator().equals(o.getOperator()) && safeSubtreeMatch(node.getLeftOperand(), o.getLeftOperand()) &&
                safeSubtreeMatch(
                        node.getRightOperand(), o.getRightOperand()));
    }
    ...
    public boolean match(InstanceofExpression node, Object other) {
        ...
        return (safeSubtreeMatch(node.getLeftOperand(), o.getLeftOperand()) && safeSubtreeMatch(node.getRightOperand(),
                                                                                                o.getRightOperand()));
    }
    ...
    public boolean match(MethodDeclaration node, Object other) {
        ...
        return ((node.isConstructor() == o.isConstructor())
                ...
                && safeSubtreeListMatch(node.thrownExceptions(), o.thrownExceptions()) && safeSubtreeMatch(node.getBody(),
                                                                                                           o.getBody()));
    }
    ...
    public boolean match(SuperConstructorInvocation node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeListMatch(node.arguments(),
                                                                                                  o.arguments()));
    }
    ...
    public boolean match(SwitchStatement node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeListMatch(node.statements(),
                                                                                                  o.statements()));
    }
        ...
        switch (node.getAST().apiLevel) {
            ...
            case AST.JLS3:
                return (safeSubtreeMatch(node.getBody(), o.getBody())
                        && safeSubtreeListMatch(node.catchClauses(), o.catchClauses()) && safeSubtreeMatch(node.getFinally(),
                                                                                                           o.getFinally()));
        }
        return (safeSubtreeListMatch(node.resources(), o.resources()) && safeSubtreeMatch(node.getBody(), o.getBody())
                && safeSubtreeListMatch(node.catchClauses(), o.catchClauses()) && safeSubtreeMatch(node.getFinally(),
                                                                                                   o.getFinally()));
    }
    ...
    public boolean match(TypeDeclaration node, Object other) {
        ...
        return ((node.isInterface() == o.isInterface()) && safeSubtreeMatch(node.getJavadoc(), o.getJavadoc())
                && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.bodyDeclarations(),
                                                                                         o.bodyDeclarations()));
    }
    ...
    public boolean match(TypeParameter node, Object other) {
        ...
        return safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.typeBounds(), o.typeBounds());
    }
    ...
    public boolean match(VariableDeclarationFragment node, Object other) {
        ...
        return safeSubtreeMatch(node.getName(), o.getName()) && node.getExtraDimensions() == o.getExtraDimensions()
               && safeSubtreeMatch(node.getInitializer(), o.getInitializer());
    }
    ...
    public boolean match(WildcardType node, Object other) {
        ...
        return node.isUpperBound() == o.isUpperBound() && safeSubtreeMatch(node.getBound(), o.getBound());
    }
