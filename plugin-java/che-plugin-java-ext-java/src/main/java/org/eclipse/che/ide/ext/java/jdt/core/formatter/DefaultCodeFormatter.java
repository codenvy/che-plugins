...
public class DefaultCodeFormatter extends CodeFormatter {
    ...
    private static final int K_MASK = K_UNKNOWN | K_EXPRESSION | K_STATEMENTS | K_CLASS_BODY_DECLARATIONS
                                      | K_COMPILATION_UNIT | K_SINGLE_LINE_COMMENT | K_MULTI_LINE_COMMENT | K_JAVA_DOC;
    ...
    public TextEdit format(int kind, String source, int offset, int length, int indentationLevel, String lineSeparator) {
        ...
        switch (kind & K_MASK) {
            case K_JAVA_DOC:
                ...
                return formatComment(kind & K_MASK, source, indentationLevel, lineSeparator, new Region[]{new RegionImpl(
                        offset, length)});
        ...
        return format(kind, source, new Region[]{new RegionImpl(offset, length)}, indentationLevel, lineSeparator);
    }

    /** {@inheritDoc} */
    public TextEdit format(int kind, String source, Region[] regions, int indentationLevel, String lineSeparator) {
    ...
    private TextEdit formatClassBodyDeclarations(String source, int indentationLevel, String lineSeparator,
                                                 Region[] regions, boolean includeComments) {
        ASTNode[] bodyDeclarations =
                this.codeSnippetParsingUtil
                        .parseClassBodyDeclarations(source.toCharArray(), getDefaultCompilerOptions(), true);
     ...
     */
    private TextEdit formatComment(int kind, String source, int indentationLevel, String lineSeparator, Region[] regions) {
        Object oldOption = oldCommentFormatOption();
        boolean isFormattingComments = false;
        if (oldOption == null) {
            switch (kind & K_MASK) {
                case K_SINGLE_LINE_COMMENT:
                    isFormattingComments =
                            DefaultCodeFormatterConstants.TRUE.equals(this.options
        ...
        if (isFormattingComments) {
            ...
            this.newCodeFormatter =
                    new CodeFormatterVisitor(this.preferences, this.options, regions, this.codeSnippetParsingUtil, true);
            Region coveredRegion = getCoveredRegion(regions);
    ...
    private TextEdit formatCompilationUnit(String source, int indentationLevel, String lineSeparator, Region[] regions,
        ...
        this.newCodeFormatter =
                new CodeFormatterVisitor(this.preferences, this.options, regions, this.codeSnippetParsingUtil, includeComments);

        return this.newCodeFormatter.format(source, compilationUnitDeclaration);
    }

    private TextEdit formatExpression(String source, int indentationLevel, String lineSeparator, Region[] regions,
                                      boolean includeComments) {
        Expression expression =
                this.codeSnippetParsingUtil.parseExpression(source.toCharArray(), getDefaultCompilerOptions(), true);
    ...
    private TextEdit formatStatements(String source, int indentationLevel, String lineSeparator, Region[] regions,
                                      boolean includeComments) {
        ConstructorDeclaration constructorDeclaration =
                this.codeSnippetParsingUtil.parseStatements(source.toCharArray(), getDefaultCompilerOptions(), true, false);
    ...
    private Region getCoveredRegion(Region[] regions) {
        ...
        Region lastRegion = regions[length - 1];

        return new RegionImpl(offset, lastRegion.getOffset() + lastRegion.getLength() - offset);
    }
    ...
    private TextEdit internalFormatClassBodyDeclarations(String source, int indentationLevel, String lineSeparator,
                                                         ASTNode[] bodyDeclarations, Region[] regions, boolean includeComments) {
        if (lineSeparator != null) {
            this.preferences.line_separator = lineSeparator;
        } else {
            this.preferences.line_separator = Util.LINE_SEPARATOR;
    ...
    private TextEdit internalFormatExpression(String source, int indentationLevel, String lineSeparator,
                                              Expression expression, Region[] regions, boolean includeComments) {
        if (lineSeparator != null) {
            this.preferences.line_separator = lineSeparator;
        } else {
            this.preferences.line_separator = Util.LINE_SEPARATOR;
    ...
    private TextEdit internalFormatStatements(String source, int indentationLevel, String lineSeparator,
                                              ConstructorDeclaration constructorDeclaration, Region[] regions, boolean includeComments) {
        if (lineSeparator != null) {
            this.preferences.line_separator = lineSeparator;
        } else {
            this.preferences.line_separator = Util.LINE_SEPARATOR;
    ...
    private TextEdit probeFormatting(String source, int indentationLevel, String lineSeparator, Region[] regions,
                                     boolean includeComments) {
    ...
    private boolean regionsSatisfiesPreconditions(Region[] regions, int maxLength) {
