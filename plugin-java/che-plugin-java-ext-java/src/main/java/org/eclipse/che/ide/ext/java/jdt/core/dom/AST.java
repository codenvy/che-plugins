...
import org.eclipse.che.ide.ext.java.jdt.core.util.StringTokenizer;
 ...
 * (see {@link org.eclipse.che.ide.ext.java.jdt.core.dom.ASTNode ASTNode} and its subclasses)
 ...
 * </pre>
 * See also {@link org.eclipse.che.ide.ext.java.jdt.core.dom.rewrite.ASTRewrite} for
...
public final class AST {
   ...
   /*package*/static final int JLS2_INTERNAL = JLS2;
     ...
     *
     * @param level
     *         the API level; one of the JLS* level constants
     * @since 3.0
     */
    private AST(int level) {
        switch (level) {
            ...
            case JLS3:
                ...
                this.scanner =
                        new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/,
     ...
     *
     * @param options
     *         the table of options (key type: <code>String</code>;
    ...
    public AST(Map<String, String> options) {
        ...
        this.scanner =
                new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, sourceLevel /*sourceLevel*/,
                            complianceLevel /*complianceLevel*/, null/*taskTag*/, null/*taskPriorities*/, true/*taskCaseSensitive*/);
    }
    ...
    public ASTNode createInstance(int nodeType) {
        ...
        return ASTNode.nodeClassForType(nodeType, this);
    }
     ...
     *
     * @param componentType
     *         the component type (possibly another array type)
     ...
     *
     * @param elementType
     *         the element type (never an array type)
     * @param dimensions
     ...
     *
     * @param keyword
     *         one of the modifier keyword constants
     ...
     *
     * @param flags
     *         bitwise or of modifier flags declared on {@link Modifier}
     ...
     * @since 3.1
     */
    public List<Modifier> newModifiers(int flags) {
        if (this.apiLevel == AST.JLS2) {
            unsupportedIn2();
        }
        List<Modifier> result = new ArrayList<Modifier>(3); // 3 modifiers is more than average
     ...
     *
     * @param type
     *         the type that is parameterized
     ...
     *
     * @param qualifier
     *         the qualifier name node
     * @param name
     *         the simple name being qualified
     ...
     *
     * @param fragment
     *         the first variable declaration fragment
