...
public class DefaultCodeFormatterConstants{
    ...
    * @since 3.1
    */
   public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.6
    */
   public static final String FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.2
    */
   public static final String FORMATTER_ALIGNMENT_FOR_ASSIGNMENT = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_ALIGNMENT_FOR_ENUM_CONSTANTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.6
    */
   public static final String FORMATTER_ALIGNMENT_FOR_METHOD_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_ALIGNMENT_FOR_RESOURCES_IN_TRY = JavaCore.PLUGIN_ID
      + ".formatter.alignment_for_resources_in_try"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_ALIGNMENT_FOR_SUPERINTERFACES_IN_ENUM_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_ALIGNMENT_FOR_UNION_TYPE_IN_MULTICATCH = JavaCore.PLUGIN_ID
      + ".formatter.alignment_for_union_type_in_multicatch"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_ANNOTATION_TYPE_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_ANONYMOUS_TYPE_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_ARRAY_INITIALIZER = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_BLOCK_IN_CASE = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_CONSTRUCTOR_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_ENUM_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_METHOD_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_SWITCH = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_BRACE_POSITION_FOR_TYPE_DECLARATION = JavaCore.PLUGIN_ID
   ...
   public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_JAVADOC_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.clear_blank_lines_in_javadoc_comment"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_BLOCK_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.clear_blank_lines_in_block_comment"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_FORMAT_LINE_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.format_line_comments"; //$NON-NLS-1$
    ...
    * @since 3.6
    */
   public static final String FORMATTER_COMMENT_FORMAT_LINE_COMMENT_STARTING_ON_FIRST_COLUMN = JavaCore.PLUGIN_ID
   ...
   public final static String FORMATTER_COMMENT_PRESERVE_WHITE_SPACE_BETWEEN_CODE_AND_LINE_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.preserve_white_space_between_code_and_line_comments"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_FORMAT_BLOCK_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.format_block_comments"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_FORMAT_JAVADOC_COMMENT =
      "org.eclipse.jdt.core.formatter.comment.format_javadoc_comments"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_FORMAT_SOURCE =
      "org.eclipse.jdt.core.formatter.comment.format_source_code"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public final static String FORMATTER_COMMENT_INDENT_PARAMETER_DESCRIPTION =
      "org.eclipse.jdt.core.formatter.comment.indent_parameter_description"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_INDENT_ROOT_TAGS =
      "org.eclipse.jdt.core.formatter.comment.indent_root_tags"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS =
      "org.eclipse.jdt.core.formatter.comment.insert_new_line_before_root_tags"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_INSERT_NEW_LINE_FOR_PARAMETER =
      "org.eclipse.jdt.core.formatter.comment.insert_new_line_for_parameter"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_NEW_LINES_AT_BLOCK_BOUNDARIES =
      "org.eclipse.jdt.core.formatter.comment.new_lines_at_block_boundaries"; //$NON-NLS-1$
   ...
   public final static String FORMATTER_COMMENT_NEW_LINES_AT_JAVADOC_BOUNDARIES =
      "org.eclipse.jdt.core.formatter.comment.new_lines_at_javadoc_boundaries"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INDENT_BODY_DECLARATIONS_COMPARE_TO_ENUM_CONSTANT_HEADER = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_INDENT_BREAKS_COMPARE_TO_CASES = JavaCore.PLUGIN_ID
    ...
    * @since 3.0
    */
   public static final String FORMATTER_INDENT_SWITCHSTATEMENTS_COMPARE_TO_CASES = JavaCore.PLUGIN_ID
    ...
    * @since 3.7
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_FIELD = JavaCore.PLUGIN_ID
    ...
    * @since 3.7
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_METHOD = JavaCore.PLUGIN_ID
    ...
    * @since 3.7
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_PACKAGE = JavaCore.PLUGIN_ID
    ...
    * @since 3.7
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_TYPE = JavaCore.PLUGIN_ID
    ...
    * @since 3.4
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_PARAMETER = JavaCore.PLUGIN_ID
    ...
    * @since 3.4
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_LOCAL_VARIABLE = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_NEW_LINE_AT_END_OF_FILE_IF_MISSING = JavaCore.PLUGIN_ID
    ...
    * @since 3.2
    */
   public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ANNOTATION_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_NEW_LINE_IN_EMPTY_ENUM_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_AND_IN_TYPE_PARAMETER = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_AT_IN_ANNOTATION_TYPE_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_CLOSING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COLON_IN_FOR = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_CONSTANT_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_ENUM_DECLARATIONS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_COMMA_IN_TYPE_PARAMETERS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_ELLIPSIS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_ANGLE_BRACKET_IN_TYPE_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_TRY = JavaCore.PLUGIN_ID
      + ".formatter.insert_space_after_opening_paren_in_try"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_QUESTION_IN_WILDCARD = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_INSERT_SPACE_AFTER_SEMICOLON_IN_TRY_RESOURCES = JavaCore.PLUGIN_ID
      + ".formatter.insert_space_after_semicolon_in_try_resources"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_AND_IN_TYPE_PARAMETER = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_AT_IN_ANNOTATION_TYPE_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_TRY = JavaCore.PLUGIN_ID
      + ".formatter.insert_space_before_closing_paren_in_try"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COLON_IN_FOR = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_CONSTANT_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_ENUM_DECLARATIONS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_PARAMETERIZED_TYPE_REFERENCE = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_ARGUMENTS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_COMMA_IN_TYPE_PARAMETERS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_ELLIPSIS = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACE_IN_ENUM_DECLARATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_TRY = JavaCore.PLUGIN_ID
      + ".formatter.insert_space_before_opening_paren_in_try"; //$NON-NLS-1$
    ...
    * @since 3.2
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_RETURN = JavaCore.PLUGIN_ID
    ...
    * @since 3.3
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_PARENTHESIZED_EXPRESSION_IN_THROW = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_QUESTION_IN_WILDCARD = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_INSERT_SPACE_BEFORE_SEMICOLON_IN_TRY_RESOURCES = JavaCore.PLUGIN_ID
      + ".formatter.insert_space_before_semicolon_in_try_resources"; //$NON-NLS-1$
    ...
    * @since 3.1
    */
   public static final String FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_ENUM_CONSTANT = JavaCore.PLUGIN_ID
    ...
    * @since 3.3
    */
   public static final String FORMATTER_NEVER_INDENT_BLOCK_COMMENTS_ON_FIRST_COLUMN = JavaCore.PLUGIN_ID
    ...
    * @since 3.3
    */
   public static final String FORMATTER_NEVER_INDENT_LINE_COMMENTS_ON_FIRST_COLUMN = JavaCore.PLUGIN_ID
    ...
    * @since 3.1
    */
   public static final String FORMATTER_USE_TABS_ONLY_FOR_LEADING_INDENTATIONS = JavaCore.PLUGIN_ID
    ...
    * @since 3.3
    */
   public static final String FORMATTER_WRAP_BEFORE_BINARY_OPERATOR = JavaCore.PLUGIN_ID
    ...
    * @since 3.7.1
    */
   public static final String FORMATTER_WRAP_BEFORE_OR_OPERATOR_MULTICATCH = JavaCore.PLUGIN_ID
      + ".formatter.wrap_before_or_operator_multicatch"; //$NON-NLS-1$
    ...
    * @since 3.6
    */
   public static final String FORMATTER_WRAP_OUTER_EXPRESSIONS_WHEN_NESTED = JavaCore.PLUGIN_ID
