...
public class ASTRewritingTypeDeclTest extends ASTRewritingTest {
    ...
    public void testTypeDeclChanges2() throws Exception {
        ...
        { // add modifier, change to class, add supertype
            ...
            rewrite.getListRewrite(type, TypeDeclaration.MODIFIERS2_PROPERTY).insertFirst(
    ...
    public void testTypeDeclInserts() throws Exception {
        ...
        { // add interface & set to final
         ...
         /* bug 22161 SimpleName newSuperclass= ast.newSimpleName("Exception");
    ...
    public void testAnonymousClassDeclaration() throws Exception {
        ...
        { // insert body decl in AnonymousClassDeclaration
            ...
            rewrite.getListRewrite(anonym, AnonymousClassDeclaration.BODY_DECLARATIONS_PROPERTY).insertFirst(newMethod,
                                                                                                             null);
        }
    ...
    public void testSingleMemberAnnotation1() throws Exception {
        ...
        try {
            ...
            JavaCore.getOptions().put(
                    DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION, JavaCore.INSERT);
            ...
            if (previousValue != null) {
                JavaCore.getOptions().put(
                        DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANNOTATION, previousValue);
            }
        }
    }
