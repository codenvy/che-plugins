...
import org.eclipse.che.ide.extension.maven.server.projecttype.handler.MavenProjectCreated;
...
public class MavenModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Multibinder.newSetBinder(binder(), ProjectHandler.class).addBinding().to(MavenProjectCreated.class);
