...
/**
 * @see org.eclipse.jdt.core.IJavaModelStatus
 */
...
public class JavaModelStatus extends Status implements IJavaModelStatus, IJavaModelStatusConstants {
	 ...
	 * Singleton OK object
	 */
	public static final IJavaModelStatus VERIFIED_OK = new org.eclipse.jdt.internal.core.JavaModelStatus(OK, OK, Messages.status_OK);
			...
			switch (getCode()) {
				...
				case NAME_COLLISION:
					if (this.elements != null && this.elements.length > 0) {
						...
						if (element instanceof org.eclipse.jdt.internal.core.PackageFragment && ((PackageFragment) element).isDefaultPackage()) {
