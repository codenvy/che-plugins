 ...
 * {@link SearchPattern#createPattern(String, int, int, int)}, {@link SearchPattern#createPattern(org.eclipse.jdt.core.IJavaElement, int)},
...
//	}
     ...
     *
     * @param project
     *         the project to which to constrain the search, or <code>null</code> if
     *         search should consider all types in the workspace
     * @param type
     *         the focus of the hierarchy scope
     * @param onlySubtypes
     *         if <code>true</code> only subtypes of <code>type</code> are considered
     * @param includeFocusType
     *         if true the focus type <code>type</code> is included in the resulting scope,
     ...
     * @since 3.6
     */
    public static IJavaSearchScope createStrictHierarchyScope(IJavaProject project, IType type, boolean onlySubtypes,
                                                              boolean includeFocusType, WorkingCopyOwner owner) throws
                                                                                                                JavaModelException {
     ...
     * <p>
     * If an element is an {@link org.eclipse.jdt.core.IJavaProject}, then the project's source folders,
     ...
     * <p>If an element is an {@link org.eclipse.jdt.core.IPackageFragmentRoot}, then only the package fragments of
     * this package fragment root will be included.</p>
     * <p>If an element is an {@link org.eclipse.jdt.core.IPackageFragment}, then only the compilation unit and class
     ...
     * be children of the given elements.
     * <p/>
     * <p>If an element is an {@link org.eclipse.jdt.core.IJavaProject}, then the project's source folders,
     ...
     *         <ul>
     *         <li>{@link org.eclipse.jdt.core.search.IJavaSearchConstants#DECLARATIONS}: will search declarations matching with the
     *         corresponding
     ...
     *         {@link org.eclipse.jdt.core.search.IJavaSearchConstants#INTERFACE} is respectively used instead of {@link
     ...
     * sensitive search, use <code>search(workspace, createSearchPattern(patternString, searchFor, limitTo, true), scope,
...
//		}
     ...
     *         the workspace
     * @param element
     *         the Java element to be searched for
     * @param limitTo
     *         one of the following values:
     *         <ul>
     *         <li>{@link IJavaSearchConstants#DECLARATIONS}: search
...
//		}
     ...
     * @since 3.0
     */
    public void search(SearchPattern pattern, SearchParticipant[] participants, IJavaSearchScope scope, SearchRequestor requestor,
     ...
     *         {@link #searchAllTypeNames(char[], int, char[], int, int, IJavaSearchScope, TypeNameRequestor, int,
     ...
     *         e.g. {@link SearchPattern#R_EXACT_MATCH} | {@link SearchPattern#R_CASE_SENSITIVE} if an exact and case sensitive match is
     *         requested,
     ...
     *         the progress monitor to report progress to, or <code>null</code> if no progress
     *         monitor is provided
     * @throws org.eclipse.jdt.core.JavaModelException
     *         if the search failed. Reasons include:
     *         <ul>
     ...
     *         </ul>
     * @since 3.1
     * @deprecated Use {@link #searchAllTypeNames(char[], int, char[], int, int, IJavaSearchScope, TypeNameRequestor, int,
     * org.eclipse.core.runtime.IProgressMonitor)}
     * instead
     */
    @Deprecated
    public void searchAllTypeNames(
        ...
        searchAllTypeNames(packageExactName, SearchPattern.R_EXACT_MATCH, typeName, matchRule, searchFor, scope, nameRequestor,
    ...
    public void searchAllTypeNames(
        ...
        this.basicEngine
                .searchAllTypeNames(packageName, SearchPattern.R_EXACT_MATCH, typeName, matchRule, searchFor, scope, requestorAdapter,
                                    waitingPolicy, progressMonitor);
    }
     ...
     * @since 3.0
     */
    public void searchDeclarationsOfAccessedFields(IJavaElement enclosingElement, SearchRequestor requestor, IProgressMonitor monitor)
            throws
    ...
    public void searchDeclarationsOfAccessedFields(IWorkspace workspace, IJavaElement enclosingElement,
        ...
        this.basicEngine.searchDeclarations(enclosingElement, new ResultCollectorAdapter(resultCollector), pattern, resultCollector
                .getProgressMonitor());
    }
     ...
     * @since 3.0
     */
    public void searchDeclarationsOfReferencedTypes(IJavaElement enclosingElement, SearchRequestor requestor, IProgressMonitor monitor)
            throws
            JavaModelException {
