...
public class SubversionProjectImporterTest {
    ...
    public void testValidImportSources() throws Exception {
        ...
        String locale = Paths.get(repoRoot.getAbsolutePath()).toUri().toString();
        projectImporter.importSources(project, locale, null, new TestUtils.SystemOutLineConsumerFactory());
